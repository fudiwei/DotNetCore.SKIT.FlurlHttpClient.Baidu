    ...
    public class CodeAnalyzeTests
    {
        ...
        public void CodeAnalyze()
        {
            ...
            Assert.Null(Record.Exception(() =>
            {
                ...
                {
                    SdkAssembly = Assembly.GetAssembly(typeof(BaiduTranslateClient))!,
                    SdkRequestModelDeclarationNamespace = "SKIT.FlurlHttpClient.Baidu.Translate.Models",
                    SdkResponseModelDeclarationNamespace = "SKIT.FlurlHttpClient.Baidu.Translate.Models",
                    SdkExecutingExtensionDeclarationNamespace = "SKIT.FlurlHttpClient.Baidu.Translate",
            ...
            Assert.Null(Record.Exception(() =>
            {
                ...
                var options = new SourceFileAnalyzerOptions()
                {
                    ...
                    SdkRequestModelDeclarationNamespace = "SKIT.FlurlHttpClient.Baidu.Translate.Models",
                    SdkResponseModelDeclarationNamespace = "SKIT.FlurlHttpClient.Baidu.Translate.Models",
                    ProjectSourceRootDirectory = Path.Combine(projdir, "./src/SKIT.FlurlHttpClient.Baidu.Translate/"),
                    ProjectTestRootDirectory = Path.Combine(projdir, "./test/SKIT.FlurlHttpClient.Baidu.Translate.UnitTests/"),
