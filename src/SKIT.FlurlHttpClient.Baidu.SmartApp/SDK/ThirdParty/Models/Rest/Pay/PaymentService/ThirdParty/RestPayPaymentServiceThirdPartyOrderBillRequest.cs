...
{
    /// <summary>
    /// <para>表示 [GET] /rest/2.0/smartapp/pay/paymentservice/tp/orderBill 接口的请求。</para>
    /// </summary>
    public class RestPayPaymentServiceThirdPartyOrderBillRequest : BaiduSmartAppThirdPartyRequest
    {
        /// <summary>
