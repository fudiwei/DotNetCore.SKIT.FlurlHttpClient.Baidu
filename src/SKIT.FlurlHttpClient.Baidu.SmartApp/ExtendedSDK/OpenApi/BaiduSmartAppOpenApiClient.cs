...
namespace SKIT.FlurlHttpClient.Baidu.SmartApp.ExtendedSDK.OpenApi
{
    ...
    public class BaiduSmartAppOpenApiClient : CommonClientBase, ICommonClient
    {
        ...
        internal protected BaiduSmartAppOpenApiClient(BaiduSmartAppOpenApiClientOptions options, HttpClient? httpClient, bool disposeClient = true)
        ...
        /// <returns></returns>
        public IFlurlRequest CreateFlurlRequest(BaiduSmartAppOpenApiRequest request, HttpMethod httpMethod, params object[] urlSegments)
        {
