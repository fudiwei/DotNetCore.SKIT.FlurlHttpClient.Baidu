...
{
    /// <summary>
    /// <para>表示 [GET] /rest/2.0/smartapp/pay/paymentservice/tp/findByTpOrderId 接口的响应。</para>
    /// </summary>
    public class RestPayPaymentServiceThirdPartyFindByOutOrderIdResponse : BaiduSmartAppThirdPartyResponse<RestPayPaymentServiceThirdPartyFindByOutOrderIdResponse.Types.Data>
    {
