...
{
    /// <summary>
    /// <para>表示 [POST] /rest/2.0/smartapp/ordercenter/app/update/sub/status 接口的请求。</para>
    /// </summary>
    public class RestOrderCenterAppUpdateSubStatusRequest : BaiduSmartAppOpenApiRequest
    {
