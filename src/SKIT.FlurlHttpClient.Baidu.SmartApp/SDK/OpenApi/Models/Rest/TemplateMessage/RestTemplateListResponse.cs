...
{
    /// <summary>
    /// <para>表示 [GET] /rest/2.0/smartapp/template/templatelist 接口的响应。</para>
    /// </summary>
    public class RestTemplateListResponse : BaiduSmartAppOpenApiResponse<RestTemplateListResponse.Types.Data>
    {
