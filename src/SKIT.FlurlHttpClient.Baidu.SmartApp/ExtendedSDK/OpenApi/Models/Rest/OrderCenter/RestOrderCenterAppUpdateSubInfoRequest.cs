...
{
    /// <summary>
    /// <para>表示 [POST] /rest/2.0/smartapp/ordercenter/app/update/sub/info 接口的请求。</para>
    /// </summary>
    public class RestOrderCenterAppUpdateSubInfoRequest : BaiduSmartAppOpenApiRequest
    {
        public static class Types
        {
            public class Order : RestOrderCenterAppAppendSubInfoRequest.Types.Order
            {
                public static new class Types
                {
                    public class ExtendedInfo : RestOrderCenterAppAppendSubInfoRequest.Types.Order.Types.ExtendedInfo
                    {
                        public static new class Types
                        {
                            public class AftersaleOrderList : RestOrderCenterAppAppendSubInfoRequest.Types.Order.Types.ExtendedInfo.Types.AftersaleOrderList
                            {
                                /// <summary>
                                /// 获取或设置售后单列表。
                                /// </summary>
                            ...
                            public class AftersaleOrderItem : RestOrderCenterAppAppendSubInfoRequest.Types.Order.Types.ExtendedInfo.Types.AftersaleOrderItem
                            {
                                public static new class Types
                                {
                                    public class Refund : RestOrderCenterAppAppendSubInfoRequest.Types.Order.Types.ExtendedInfo.Types.AftersaleOrderItem.Types.Refund
                                    {
                                        public static new class Types
                                        {
                                            public class Product : RestOrderCenterAppAppendSubInfoRequest.Types.Order.Types.ExtendedInfo.Types.AftersaleOrderItem.Types.Refund.Types.Product
                                            {
                                            }
                                        }
                    ...
                    public class DetailedPageInfo : RestOrderCenterAppAppendSubInfoRequest.Types.Order.Types.DetailedPageInfo
                    {
                    }
                }
