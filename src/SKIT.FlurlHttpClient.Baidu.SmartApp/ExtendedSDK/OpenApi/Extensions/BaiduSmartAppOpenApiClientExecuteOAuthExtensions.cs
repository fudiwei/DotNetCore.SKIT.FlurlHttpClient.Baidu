...
namespace SKIT.FlurlHttpClient.Baidu.SmartApp.ExtendedSDK.OpenApi
{
    public static class BaiduSmartAppOpenApiClientExecuteOAuthExtensions
    {
        ...
        /// <para>
        /// REF: <br/>
        /// <![CDATA[ https://smartprogram.baidu.com/docs/develop/serverapi/power_exp/ ]]>
        /// </para>
        /// </summary>
        ...
        public static async Task<Models.OAuthTokenResponse> ExecuteOAuthTokenAsync(this BaiduSmartAppOpenApiClient client, Models.OAuthTokenRequest request, CancellationToken cancellationToken = default)
        {
            ...
            IFlurlRequest flurlReq = client
                .CreateFlurlRequest(request, HttpMethod.Get, "oauth", "2.0", "token")
            ...
            return await client.SendFlurlRequestAsJsonAsync<Models.OAuthTokenResponse>(flurlReq, data: request, cancellationToken: cancellationToken).ConfigureAwait(false);
        }
    }
}
