...
namespace SKIT.FlurlHttpClient.Baidu.SmartApp.ExtendedSDK.ThirdParty
{
    public static class BaiduSmartAppThirdPartyClientExecutePublicExtensions
    {
        ...
        /// <para>
        /// REF: <br/>
        /// <![CDATA[ https://smartprogram.baidu.com/docs/third/auth/access_token/ ]]>
        /// </para>
        /// </summary>
        ...
        public static async Task<Models.PublicAuthThirdPartyTokenResponse> ExecutePublicAuthThirdPartyTokenAsync(this BaiduSmartAppThirdPartyClient client, Models.PublicAuthThirdPartyTokenRequest request, CancellationToken cancellationToken = default)
        {
            ...
            IFlurlRequest flurlReq = client
                .CreateFlurlRequest(request, HttpMethod.Get, "public", "2.0", "smartapp", "auth", "tp", "token")
                .SetQueryParam("client_id", client.Credentials.AppKey)
                .SetQueryParam("ticket", request.Ticket);

            return await client.SendFlurlRequestAsJsonAsync<Models.PublicAuthThirdPartyTokenResponse>(flurlReq, data: request, cancellationToken: cancellationToken).ConfigureAwait(false);
        }
    }
}
