...
{
    /// <summary>
    /// <para>表示 [GET] /rest/2.0/smartapp/pay/paymentservice/tp/findOrderRefund 接口的请求。</para>
    /// </summary>
    public class RestPayPaymentServiceThirdPartyFindOrderRefundRequest : BaiduSmartAppThirdPartyRequest
    {
        /// <summary>
