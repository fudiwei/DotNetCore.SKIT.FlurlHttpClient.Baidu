...
{
    /// <summary>
    /// <para>表示 [POST] /rest/2.0/smartapp/oss/publisher/ugc/like_count 接口的响应。</para>
    /// </summary>
    public class RestOSSPublisherUGCLikeCountResponse : BaiduSmartAppOpenApiResponse<RestOSSPublisherUGCLikeCountResponse.Types.Data>
    {
