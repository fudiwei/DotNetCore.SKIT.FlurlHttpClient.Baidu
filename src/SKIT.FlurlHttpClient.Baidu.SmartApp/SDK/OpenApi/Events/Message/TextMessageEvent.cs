namespace SKIT.FlurlHttpClient.Baidu.SmartApp.SDK.OpenApi.Events
{
    ...
    /// </summary>
    public class TextMessageEvent : BaiduSmartAppOpenApiEvent, BaiduSmartAppOpenApiEvent.Serialization.IJsonSerializable, BaiduSmartAppOpenApiEvent.Serialization.IXmlSerializable
    {
        /// <summary>
        /// 获取或设置消息 ID。
        /// </summary>
