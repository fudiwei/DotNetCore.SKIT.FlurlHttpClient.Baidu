    ...
    internal class TestConfigs
    {
        static TestConfigs()
        {
            ...
            try
            {
                ...
                BaiduPushApiKey = config.GetProperty("ApiKey").GetString()!;
                BaiduPushApiSecretKey = config.GetProperty("ApiSecretKey").GetString()!;
        ...
        public static readonly string BaiduPushApiKey;
        public static readonly string BaiduPushApiSecretKey;
