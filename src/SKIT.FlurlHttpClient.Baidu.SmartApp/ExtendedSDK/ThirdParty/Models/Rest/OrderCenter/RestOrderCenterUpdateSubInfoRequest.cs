...
{
    /// <summary>
    /// <para>表示 [POST] /rest/2.0/smartapp/ordercenter/update/sub/info 接口的请求。</para>
    /// </summary>
    public class RestOrderCenterUpdateSubInfoRequest : BaiduSmartAppThirdPartyRequest
    {
                ...
                public static new class Types
                {
                    public class ExtendedInfo : RestOrderCenterAppendSubInfoRequest.Types.Order.Types.ExtendedInfo
                    {
                        public static new class Types
                        {
                            ...
                            public class AftersaleOrderItem : RestOrderCenterAppendSubInfoRequest.Types.Order.Types.ExtendedInfo.Types.AftersaleOrderItem
                            {
                                public static new class Types
                                {
                                    public class Refund : RestOrderCenterAppendSubInfoRequest.Types.Order.Types.ExtendedInfo.Types.AftersaleOrderItem.Types.Refund
                                    {
                                        public static new class Types
                                        {
                                            public class Product : RestOrderCenterAppendSubInfoRequest.Types.Order.Types.ExtendedInfo.Types.AftersaleOrderItem.Types.Refund.Types.Product
                                            {
                                            }
                                        }
