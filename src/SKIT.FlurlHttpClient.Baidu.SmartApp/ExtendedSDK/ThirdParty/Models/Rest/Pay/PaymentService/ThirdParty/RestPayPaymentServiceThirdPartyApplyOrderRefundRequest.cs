...
{
    /// <summary>
    /// <para>表示 [POST] /rest/2.0/smartapp/pay/paymentservice/tp/applyOrderRefund 接口的请求。</para>
    /// </summary>
    public class RestPayPaymentServiceThirdPartyApplyOrderRefundRequest : BaiduSmartAppThirdPartyRequest
    {
        /// <summary>
