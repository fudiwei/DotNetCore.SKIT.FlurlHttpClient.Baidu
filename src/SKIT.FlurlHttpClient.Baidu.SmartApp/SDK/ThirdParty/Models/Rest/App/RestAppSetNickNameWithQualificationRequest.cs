...
namespace SKIT.FlurlHttpClient.Baidu.SmartApp.SDK.ThirdParty.Models
{
    ...
    public class RestAppSetNickNameWithQualificationRequest : BaiduSmartAppThirdPartyRequest
    {
        ...
        {
            internal class RequestPropertyQualificationMaterialNewtonsoftJsonConverter : Newtonsoft.Json.Converters.TextualObjectInJsonFormatConverterBase<Types.QualificationMaterial?>
            {
            }

            internal class RequestPropertyQualificationMaterialSystemTextJsonConverter : System.Text.Json.Converters.TextualObjectInJsonFormatConverterBase<Types.QualificationMaterial?>
            {
            }
        }
        ...
        [Newtonsoft.Json.JsonConverter(typeof(Converters.RequestPropertyQualificationMaterialNewtonsoftJsonConverter))]
        [System.Text.Json.Serialization.JsonPropertyName("qual_materials")]
        [System.Text.Json.Serialization.JsonConverter(typeof(Converters.RequestPropertyQualificationMaterialSystemTextJsonConverter))]
