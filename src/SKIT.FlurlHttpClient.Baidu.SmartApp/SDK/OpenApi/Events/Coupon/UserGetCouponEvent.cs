namespace SKIT.FlurlHttpClient.Baidu.SmartApp.SDK.OpenApi.Events
{
    ...
    /// <para>REF: https://smartprogram.baidu.com/docs/develop/api/open/coupons_collect/ </para>
    /// </summary>
    public class UserGetCouponEvent : BaiduSmartAppOpenApiEvent, BaiduSmartAppOpenApiEvent.Serialization.IJsonSerializable, BaiduSmartAppOpenApiEvent.Serialization.IXmlSerializable
    {
        /// <summary>
        /// 获取或设置卡券 ID。
        /// </summary>
